...
if (process.env.NODE_ENV === 'production') {
    ...
    app.get('*', (req, res) => res.sendFile(path.resolve(process.cwd() , '/build' , 'index.html')))
} else {
    app.get('/', (req, res) => {
...
console.log(`path.resolve(process.cwd() , '/build')`, path.resolve(process.cwd() , '/build'))
console.log(`path.resolve(process.cwd() , '/build', 'index.html')`, path.resolve(process.cwd() , '/build' , 'index.html'))
